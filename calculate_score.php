...
(SELECT COUNT(*) FROM RSMSSQL.DAILY_FACTORY_5S.dbo.MASTER_QUESTION WITH (NOLOCK) WHERE KEYID NOT IN (1, 2)) AS FactoryQC,

(SELECT COUNT(*) FROM RSMSSQL.DAILY_OFFICE_5S.dbo.MASTER_QUESTION WITH (NOLOCK)) AS OfficeQC
